<div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
    <ul class="navbar-nav u-header__navbar-nav">
        ...
        <li class="nav-item hs-has-mega-menu u-header__nav-item"
            ...
            data-position="left">
            <a id="homeMegaMenu" class="nav-link u-header__nav-link u-header__nav-link-toggle" href="javascript:;" aria-haspopup="true" aria-expanded="false">Главная</a>
                ...
                <div class="row u-header__mega-menu-wrapper">
                    ...
                    <div class="col-md-3">
                        <a href="#" class="d-block mb-3">
                            <img class="img-fluid" src="/public/img/300X275/img1.jpg" alt="Image Description">
                        </a>
                        <a href="#" class="d-block">
                            <img class="img-fluid" src="/public/img/300X275/img2.jpg" alt="Image Description">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <li class="nav-item hs-has-mega-menu u-header__nav-item"
            ...
            <div class="hs-mega-menu w-100 u-header__sub-menu" aria-labelledby="smartphonesMegaMenu">
                <div class="row u-header__mega-menu-wrapper">
                    ...
                    <div class="col-md-4">
                        <a href="#" class="d-block">
                            <img class="img-fluid" src="/public/img/1024X1024/img1.jpg" alt="Image Description">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <li class="nav-item hs-has-mega-menu u-header__nav-item"
            ...
            <div class="hs-mega-menu w-100 u-header__sub-menu" aria-labelledby="laptopsdesktopsMegaMenu">
                <div class="row u-header__mega-menu-wrapper">
                    ...
                    <div class="col-md-4">
                        <a href="#" class="d-block">
                            <img class="img-fluid" src="/public/img/1024X1024/img2.jpg" alt="Image Description">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="row u-header__mega-menu-wrapper">
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <a href="#" class="d-block">
                                    <img class="img-fluid" src="/public/img/300X275/img3.jpg" alt="Image Description">
                                </a>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6">
                                <a href="#" class="d-block">
                                    <img class="img-fluid" src="/public/img/300X275/img4.jpg" alt="Image Description">
                                </a>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <a href="#" class="d-block">
                                    <img class="img-fluid" src="/public/img/300X275/img5.jpg" alt="Image Description">
                                </a>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6">
                                <a href="#" class="d-block">
                                    <img class="img-fluid" src="/public/img/300X275/img6.jpg" alt="Image Description">
                                </a>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <a href="#" class="d-block">
                                    <img class="img-fluid" src="/public/img/300X275/img7.jpg" alt="Image Description">
                                </a>
                            </div>
                            <div class="col-md-6 mb-3">
                                <span class="u-header__sub-menu-title">Accessories</span>
                            ...
                            <div class="col-md-6">
                                <a href="#" class="d-block">
                                    <img class="img-fluid" src="/public/img/300X275/img8.jpg" alt="Image Description">
                                </a>
                            </div>
                            <div class="col-md-6">
        ...
        <li class="nav-item hs-has-mega-menu u-header__nav-item"
            ...
            <div class="hs-mega-menu w-100 u-header__sub-menu" aria-labelledby="GPSCarMegaMenu" style="min-width: 330px;">
                <div class="row u-header__mega-menu-wrapper">
                    ...
                    <div class="col-md-4">
                        <a href="#" class="d-block">
                            <img class="img-fluid" src="/public/img/1024X1024/img3.jpg" alt="Image Description">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <li class="nav-item hs-has-mega-menu u-header__nav-item"
            ...
            <div class="hs-mega-menu w-100 u-header__sub-menu" aria-labelledby="CamerasAccessoriesMegaMenu">
                <div class="row u-header__mega-menu-wrapper">
                    ...
                    <div class="col-md-4">
                        <a href="#" class="d-block">
                            <img class="img-fluid" src="/public/img/1024X1024/img4.png" alt="Image Description">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="row u-header__mega-menu-wrapper">
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col">
                                <a href="#" class="d-block">
                                    <img class="img-fluid" src="/public/img/300X275/img9.jpg" alt="Image Description">
                                </a>
                            </div>
                            <div class="col">
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col">
                                <a href="#" class="d-block">
                                    <img class="img-fluid" src="/public/img/300X275/img10.jpg" alt="Image Description">
                                </a>
                            </div>
                            <div class="col">
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col">
                                <a href="#" class="d-block">
                                    <img class="img-fluid" src="/public/img/300X275/img11.jpg" alt="Image Description">
                                </a>
                            </div>
                            <div class="col">
