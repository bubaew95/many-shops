                                                ...
                                                <ul id="headerSidebarList" class="u-header-collapse__nav">
                                                    ...
                                                    <li class="u-has-submenu u-header-collapse__submenu">
                                                        <a class="u-header-collapse__nav-link u-header-collapse__nav-pointer"
                                                           href="<?= Url::to(['shops/'])?>"
                                                           role="button" data-toggle="collapse" aria-expanded="false" aria-controls="headerSidebarPagesCollapse">
                                                            Магазины
                                                        </a>
                                                    </li>
                                                    <!-- End Shop Pages -->
                        ...
                        <div class="d-inline-flex">
                            <ul class="d-flex list-unstyled mb-0 align-items-center">
                                ...
                                <li class="col pr-xl-0 px-2 px-sm-3">
                                    <a href="<?= Url::to(['/shops/cart/index'])?>" class="text-gray-90 position-relative d-flex " data-toggle="tooltip" data-placement="top" title="Cart">
                                        ...
                                        <span class="width-22 height-22 bg-dark position-absolute d-flex align-items-center justify-content-center rounded-circle left-12 top-8 font-weight-bold font-size-12 text-white">
                                            <?= $_SESSION['cart']['items'] ? count($_SESSION['cart']['items']) : 0 ?>
                                        </span>
                                        <span class="d-none d-xl-block font-weight-bold font-size-16 text-gray-90 ml-3">
                                            <?= $_SESSION['cart']['totalSum'] ? $_SESSION['cart']['totalSum'] . RUB : null ?>
                                        </span>
                                    </a>
                                </li>
