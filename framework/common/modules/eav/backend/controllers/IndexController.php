...
namespace common\modules\eav\backend\controllers;

use common\modules\eav\backend\models\EavForm;
use Yii;
use common\modules\eav\models\EavAttribute;
use common\modules\eav\models\search\EavAttributeSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * IndexController implements the CRUD actions for EavAttribute model.
 */
