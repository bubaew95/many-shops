...
use common\modules\eav\backend\admin\assets\FbAsset;
use yii\web\View;
...
if(file_exists(Yii::getAlias('@common') . '/modules/eav/backend/admin/assets/formbuilder/locales/'.Yii::$app->language.'.js')){
